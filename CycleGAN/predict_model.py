# import torch
# import torchaudio
# from CycleGAN.models.autoencoder import Autoencoder
# from models.generator import Generator
# from CycleGAN.models.discriminator import pl_Discriminator
...
#         noisy_file = torch.stft(noisy_waveform, n_fft=512, hop_length=100, win_length=400, window=torch.hann_window(400).to(device), return_complex=True)
#         noisy_file = torch.stack((noisy_file.real, noisy_file.imag), dim=1)
#         fake_clean = generator(noisy_file)
#         fake_clean = stft_to_waveform(fake_clean[0], device = device)
#         torchaudio.save(f'data/standard_fake_clean/{noisy_filenames[i]}', fake_clean, 16000)


# if __name__ == '__main__':
#     pass
#     generate_fake_clean('models/Standard_Model.ckpt')
