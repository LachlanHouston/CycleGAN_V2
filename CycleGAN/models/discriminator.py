...
class STN3d(nn.Module):
    ...
    def forward(self, x):
        ...
        x = F.relu(self.conv1(x))                                    # apply the first convolutional layer, batch normalization and relu activation
        x = F.relu(self.conv2(x))                                    # apply the second convolutional layer, batch normalization and relu activation
        x = F.relu(self.conv3(x))                                    # apply the third convolutional layer, batch normalization and relu activation
        ...
        x = F.relu(self.fc1(x))                                       # apply the first fully connected layer, batch normalization and relu activation
        x = F.relu(self.fc2(x))                                       # apply the second fully connected layer, batch normalization and relu activation
...
class Discriminator(nn.Module):
    def __init__(self, k=1):
        ...
        # linear block
        self.fc1 = nn.Linear(256, int(128/r))
        self.fc2 = nn.Linear(int(128/r), int(32/r))
        self.fc3 = nn.Linear(int(32/r), k)
